            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form action="{{ route('campaigns.update', $campaign->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <!-- Form fields for editing campaign data -->
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="amount" name="amount" value="{{ $campaign->amount }}">
                        </div>
                        <div class="form-group">
                            <label for="deadline">Deadline:</label>
                            <input type="date" class="form-control" id="deadline" name="deadline" value="{{ $campaign->deadline }}">
                        </div>
                        <br>
                        <!-- Add more form fields for other campaign data -->
